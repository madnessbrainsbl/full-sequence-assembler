...
#==============================================================================
# SNOBZ parameters for Tesla2d54 notch design ( HIGH_BANDWIDTH_VER )
snoNotches_282_VCM = [
{
   ...
   'FILTERS': 2**2+2**5,
   'NBR_NOTCHES': (2),
   'BANDWIDTH_BY_ZONE': (0,0,0,0,400,500,),
   'NOTCH_DEPTH_BY_ZONE': (0,0,0,0,900,1800,),
   'SNO_METHOD': 8,
   'HEAD_RANGE': (0x00FF),
   'spc_id': 31,
},
...
snoNotches_282_DAC = [
{
   ...
   'FILTERS': 2**1+2**10,
   'NBR_NOTCHES': (2),
   'BANDWIDTH_BY_ZONE': (0,0,0,0,1000,1800,),
   'NOTCH_DEPTH_BY_ZONE': (0,0,0,0,1400,1800,),
   'SNO_METHOD': 8,
   'HEAD_RANGE': (0x00FF),
